...
export default function AddWarrantyModal({ onClose, onCreated, clients }: AddWarrantyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex justify-center items-center px-4">
      <form
        ...
        className="bg-white w-full max-w-md p-6 rounded-xl shadow-lg space-y-4 relative"
      >
        <button
          onClick={onClose}
          type="button"
        ...
        <h2 className="text-xl font-semibold text-center text-[var(--color-text-primary)]">Add Warranty</h2>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-[var(--color-accent)] hover:bg-opacity-90 text-white py-2 rounded-full text-sm flex justify-center items-center gap-2 transition"
        >
